...
echo "  sudo cp deploy/ai-radar-aws.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable ai-radar-aws"
echo "  sudo systemctl start ai-radar-aws"